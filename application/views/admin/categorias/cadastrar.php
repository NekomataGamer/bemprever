    ...
    <div class="col-lg-10 p-0 mx-auto">
        <div class="row">
            <div class="col-md-6 mb-24pt mb-md-0">
                <form action="<?php echo base_url(); ?>admin/categorias/insere" enctype="multipart/form-data" method="POST">
                    <div class="form-group">
                        <label class="form-label" for="name">Nome: *</label>
                        <input id="nome" type="text" class="form-control" placeholder="Nome do Serviço" name="titulo" required>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="form-label" for="foto">Link Imagem</label>
                        <textarea name="link" class="form-control" placeholder="Descrição do serviço" rows="1"></textarea>
                    </div>
                            ...
                            <div class="d-flex flex-wrap align-items-start">
                                ...
                                <div class="flex" style="min-width: 180px">
                                    <small class="text-100">
                                        Preencha os dados para inserir uma nova categoria no sistema.
                                    </small>
                                </div>
                            </div>
                        </div>
