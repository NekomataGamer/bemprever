...
<div class="main-content">
  ...
  <!-- Modal -->
  <div class="modal fade" id="modalAceitarSaque" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <!-- Modal -->
  <div class="modal fade" id="modalRejeitarSaque" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
  ...
  <!-- Modal -->
  <div class="modal fade" id="modalInfoAss" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
  ...
  <!-- Modal -->
  <div class="modal fade" id="modalInfoSq" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
    ...
    function geraAlerta(titulo, texto, footer = "", tipomodal = "") {
      if ($('#modal_aviso').length) {
        ...
        if (footer !== "") {
          ...
          if ($('#modal_aviso .modal-footer').length) {
            $('#modal_aviso .modal-footer').remove();
          }
        }
      } else {
