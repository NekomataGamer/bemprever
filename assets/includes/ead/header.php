                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link d-flex align-items-center dropdown-toggle" data-toggle="dropdown" data-caret="false">
                            ...
                            <span class="avatar avatar-sm mr-8pt2">
                                <img src="<?php echo getImgPerf($this->session->userdata('foto')); ?>" class="avatar-title rounded-circle img-fluid bg-primary" alt="perfil" />
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <a class="dropdown-item" href="<?php echo site_url('ead/perfil'); ?>">Meu Perfil</a>
                            <a class="dropdown-item" href="<?php echo site_url('ead/login/logoff'); ?>">Sair</a>
                        </div>
                    </div>
                </div>
