                                    ...
                                    <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_1">
                                        ...
                                        <tbody>
                                            ...
                                            <?php foreach($lastUsers as $user):?>
                                                ...
                                                <td>
                                                    <span class="text-dark-75 font-weight-bolder d-block font-size-lg">#<?php echo $user['id_indicador'];?></span>
                                                ...
                                                <td>
                                                    <div class="d-flex flex-column w-100 mr-2">
                                                        <div class="d-flex align-items-center justify-content-between mb-2">
                                                            ...
                                                            <span class="text-muted font-size-sm font-weight-bold"><?php echo ($user['ativo'] == 1)?'Ativo':'Inativo';?></span>
                                                        </div>
                                                        <div class="progress progress-xs w-100">
                                                            <div class="progress-bar bg-<?php echo ($user['ativo'] == 1)?'success':'danger';?>" role="progressbar" style="width: 100%;" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                                                        </div>
                                                    </div>
                                                </td>
