	...
	<div class="offcanvas-content pr-5 mr-n5">
		...
		<div class="d-flex align-items-center mt-5">
			<div class="symbol symbol-100 mr-5">
				<div class="symbol-label" style="background-image:url(<?php echo getImgPerf($this->session->userdata('foto')); ?>)"></div>
		...
		<div class="navi navi-spacer-x-0 p-0">
			<!--begin::Item-->
			<a href="<?php echo site_url('rede/perfil'); ?>" class="navi-item">
				<div class="navi-link">
					...
					<div class="navi-text">
						...
						<div class="text-muted">Configurações da minha conta
			...
			<!--end:Item-->
			<!--begin::Item-->
			<a href="<?php echo site_url('rede/dados_pagamento'); ?>" class="navi-item">
				<div class="navi-link">
					<div class="symbol symbol-40 bg-light mr-3">
						<div class="symbol-label">
					...
					<div class="navi-text">
						<div class="font-weight-bold">Dados de Pagamento</div>
						<div class="text-muted">Alterar Dados de Pagamento</div>
					</div>
				</div>
			</a>
			<a href="<?php echo site_url('rede/perfil/minhas_credenciais'); ?>" class="navi-item">
				<div class="navi-link">
					<div class="symbol symbol-40 bg-light mr-3">
						<div class="symbol-label">
					...
					<div class="navi-text">
						<div class="font-weight-bold">Minhas Credenciais</div>
						<div class="text-muted">Ver Credenciais</div>
					</div>
				</div>
			</a>
			<!--end:Item-->
			...
			<div class="tab-pane fade show pt-3 pr-5 mr-n5 active" id="kt_quick_panel_logs" role="tabpanel">
				...
				<div class="mb-15">
					...
					<div class="d-flex align-items-center flex-wrap mb-5">
						<div class="symbol symbol-50 symbol-light mr-5">
							<span class="symbol-label">
								<img src="<?php echo base_url('assets/assetsAlison'); ?>/media/svg/misc/006-plurk.svg" class="h-50 align-self-center" alt="" />
							</span>
						</div>
						<div class="d-flex flex-column flex-grow-1 mr-2">
					...
					<div class="d-flex align-items-center flex-wrap mb-5">
						<div class="symbol symbol-50 symbol-light mr-5">
							<span class="symbol-label">
								<img src="'assets/assetsAlison'/media/svg/misc/015-telegram.svg" class="h-50 align-self-center" alt="" />
							</span>
						</div>
						<div class="d-flex flex-column flex-grow-1 mr-2">
					...
					<div class="d-flex align-items-center flex-wrap mb-5">
						<div class="symbol symbol-50 symbol-light mr-5">
							<span class="symbol-label">
								<img src="<?php echo base_url('assets/assetsAlison'); ?>/media/svg/misc/003-puzzle.svg" class="h-50 align-self-center" alt="" />
							</span>
						</div>
						<div class="d-flex flex-column flex-grow-1 mr-2">
					...
					<div class="d-flex align-items-center flex-wrap mb-5">
						<div class="symbol symbol-50 symbol-light mr-5">
							<span class="symbol-label">
								<img src="<?php echo base_url('assets/assetsAlison'); ?>/media/svg/misc/005-bebo.svg" class="h-50 align-self-center" alt="" />
							</span>
						</div>
						<div class="d-flex flex-column flex-grow-1 mr-2">
					...
					<div class="d-flex align-items-center flex-wrap">
						<div class="symbol symbol-50 symbol-light mr-5">
							<span class="symbol-label">
								<img src="<?php echo base_url('assets/assetsAlison'); ?>/media/svg/misc/014-kickstarter.svg" class="h-50 align-self-center" alt="" />
							</span>
						</div>
						<div class="d-flex flex-column flex-grow-1 mr-2">
						...
						<div class="messages">
							...
							<div class="d-flex flex-column mb-5 align-items-start">
								<div class="d-flex align-items-center">
									<div class="symbol symbol-circle symbol-40 mr-3">
										<img alt="Pic" src="<?php echo base_url('assets/assetsAlison'); ?>/media/users/300_12.jpg" />
									</div>
									<div>
							...
							<div class="d-flex flex-column mb-5 align-items-end">
								<div class="d-flex align-items-center">
									...
									<div class="symbol symbol-circle symbol-40 ml-3">
										<img alt="Pic" src="<?php echo base_url('assets/assetsAlison'); ?>media/users/300_21.jpg" />
									</div>
								</div>
...
<script src="<?php echo site_url('assets/assetsAlison'); ?>/plugins/global/plugins.bundle.js"></script>
<script src="<?php echo site_url('assets/assetsAlison'); ?>/plugins/custom/prismjs/prismjs.bundle.js"></script>
<script src="<?php echo site_url('assets/assetsAlison'); ?>/js/scripts.bundle.js"></script>
<!--end::Global Theme Bundle-->
<!--begin::Page Vendors(used by this page)-->
<script src="<?php echo site_url('assets/assetsAlison'); ?>/plugins/custom/fullcalendar/fullcalendar.bundle.js"></script>
<!--end::Page Vendors-->
<!--begin::Page Scripts(used by this page)-->
<script src="<?php echo site_url('assets/assetsAlison'); ?>/js/pages/widgets.js"></script>
<!--end::Page Scripts-->
