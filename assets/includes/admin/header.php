      ...
      <div class="mdk-drawer-layout js-mdk-drawer-layout" data-push data-responsive-width="992px">
            <div class="mdk-drawer-layout__content page-content">
                  ...
                  <div class="navbar navbar-expand pr-0 navbar-light border-bottom-2" id="default-navbar" data-primary>
                        ...
                        <a href="<?php echo site_url('admin/index'); ?>" class="navbar-brand mr-16pt d-lg-none">
                              ...
                              <div class="nav-item dropdown">
                                    <a href="#" class="nav-link d-flex align-items-center dropdown-toggle" data-toggle="dropdown" data-caret="false">
                                          ...
                                          <span class="avatar avatar-sm mr-8pt2">
                                                ...
                                                <img src="<?php echo returnPath($this->session->userdata('foto')); ?>" class="avatar-title rounded-circle img-fluid bg-primary" alt="perfil" />

                                          </span>

                                    </a>
                                    <div class="dropdown-menu dropdown-menu-right">
                                          <div class="dropdown-header"><strong><?php echo 'Olá, ' . $this->session->userdata('nome'); ?></strong></div>
                                          <a class="dropdown-item" href="<?php echo site_url('admin/perfil'); ?>">Editar Conta</a>
                                          <a class="dropdown-item" href="<?php echo site_url('admin/login/logoff'); ?>">Sair</a>
                                    </div>
                              </div>
                        </div>
