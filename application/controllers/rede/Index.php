...
class Index extends CI_Controller {
  ...
  protected function last_users(){
    return $this->model->selecionaBusca('aluno', "WHERE id_niveis LIKE '".$this->session->userdata('id_niveis')."%'  AND id_niveis != '".$this->session->userdata('id_niveis')."' ORDER BY id DESC LIMIT 4 ");
  }
