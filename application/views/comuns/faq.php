            ...
            <?php foreach ($faq as $f) : ?>
                <div class="card">
                    <div class="card-header" id="heading<?php echo $f['id']; ?>">
                        <button class="btn btn-default" data-toggle="collapse" style="width:100%;text-align:left;" data-target="#collapse<?php echo $f['id']; ?>" aria-expanded="true" aria-controls="collapse<?php echo $f['id']; ?>">
                            <i class="fas fa-question"></i> <?php echo nl2br($f['pergunta']); ?>
                        </button>
                    </div>
