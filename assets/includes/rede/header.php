											...
											<div class="scroll scroll-push" data-scroll="true" data-height="250" data-mobile-height="200">
												...
												<div class="d-flex align-items-center justify-content-between p-8">
													...
													<a href="#" class="symbol symbol-70 flex-shrink-0">
														<img src="<?php echo base_url('assets/assetsAlison'); ?>/media/stock-600x400/img-1.jpg" title="" alt="" />
													</a>
												</div>
												<!--end::Item-->
												<!--begin::Separator-->
												...
												<div class="d-flex align-items-center justify-content-between p-8">
													...
													<a href="#" class="symbol symbol-70 flex-shrink-0">
														<img src="<?php echo base_url('assets/assetsAlison'); ?>/media/stock-600x400/img-2.jpg" title="" alt="" />
													</a>
												</div>
												<!--end::Item-->
												<!--begin::Separator-->
												...
												<div class="d-flex align-items-center justify-content-between p-8">
													...
													<a href="#" class="symbol symbol-70 flex-shrink-0">
														<img src="<?php echo base_url('assets/assetsAlison'); ?>/media/stock-600x400/img-3.jpg" title="" alt="" />
													</a>
												</div>
												<!--end::Item-->
												<!--begin::Separator-->
												...
												<div class="d-flex align-items-center justify-content-between p-8">
													...
													<a href="#" class="symbol symbol-70 flex-shrink-0">
														<img src="<?php echo base_url('assets/assetsAlison'); ?>/media/stock-600x400/img-4.jpg" title="" alt="" />
													</a>
												</div>
												<!--end::Item-->
											</div>
